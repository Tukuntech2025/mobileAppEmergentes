...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'error_dni_length': 'DNI must be exactly 8 digits',
      'error_invalid_age': 'Please enter a valid age',
      'error_phone_length': 'Phone number must be exactly 9 digits',
    ...
    'es': {
      ...
      'error_fill_all_fields': 'Por favor llena todos los campos',
      ...
      'error_dni_length': 'El DNI debe tener exactamente 8 dígitos',
      'error_invalid_age': 'Por favor ingresa una edad válida',
      'error_phone_length': 'El número de teléfono debe tener exactamente 9 dígitos',
